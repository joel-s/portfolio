...
"""
Run the whereami program (to find out which machines I have signed up to use
and when), and then use dtcm_insert to add appropriate entries to my calendar.
"""
